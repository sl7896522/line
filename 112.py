    ...
    try:
        ...
        if op.type == 5:
            ...
            if settings["autoAdd"] == True:
                cl.sendMessage(op.param1, "你好 {} 謝謝你加我為好友 :D\n       666 clp.vip666.one ".format(str(cl.getContact(op.param1).displayName)))
        if op.type == 11:
            group = cl.getGroup(op.param1)
            contact = cl.getContact(op.param2)
            if settings["qrprotect"][op.param1] == True:
                if op.param2 in ammin:
                     pass
                else:
        ...
        if op.type == 13:
            if clMID in op.param3:
                ...
                if settings["autoJoin"] == True:
                    ...
                    cl.sendMessage(op.param1, "謝謝加我進本群組")
        ...
        if op.type == 25 or op.type == 26:
            ...
            if msg.contentType == 13:
               if wait["ban"] == True:
                           msg.contentMetadata["mid"] in settings["blacklist"]:
                           ...
                           msg.contentMetadata["mid"] not in settings["blacklist"]:
                           cl.sendMessage(msg.to,"already")
                           wait["unban"] = False
                       else:
                ...
                if op.param2 not in settings['bot']:
                    if op.param1 not in settings['wel']:
                        try:
                            ...
                            arrData = {'S':slen, 'E':elen, 'M':op.param2}
                            arr.append(arrData)
                            text += mention + '!!歡迎加入群組!!!! 666娛樂城clp.vip666.one 歡迎您'
                            cl.sendMessage(op.param1,text, {'MENTION': str('{"MENTIONEES":' + json.dumps(arr) + '}')}, 0)
                        except Exception as error:
                            print(error)
                    else:
        ...
        if op.type == 26 or op.type == 25:
            ...
            if sender in Admin or sender in settings["Admin"]:
                if "miya" in msg.text.lower():
                    while 1:
                        cl.sendMessage(to, text=None, contentMetadata={'mid': "u96a3b46317475267bfc0935dc0521e67',"}, contentType=13)
                    ...
                    cl.sendContact(to, "u596f4619119f121667c98c2f93916a0f")
                    ...
                    cl.sendMessage(msg.to, text=None, contentMetadata={'mid': "u96a3b46317475267bfc0935dc0521e67',"}, contentType=13)
                    cl.sendMessage(msg.to, text=None, contentMetadata={'mid': "u96a3b46317475267bfc0935dc0521e67',"}, contentType=13)
                  ...
                  if msg.toType == 2:
                    ...
                    if msg.toType == 2:
                        ...
                        if group.preventedJoinByTicket == False:
                            ...
                            cl.sendMessage(to, "[ 群組網址 ]clp.vip666.one".format(str(ticket)))
                        else:
